...
# Caveat
You will lose the formatting if you edit the page directly. if you need to update the page, make the changes in the word document and run the command again. The best way is to automate publishing the changes using the command. But you may want to edit it directly if you want to reformat the page with what is supported within the modern page.
